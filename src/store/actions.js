...
export default {
    listProfile({commit}){
      ...
      listGenderChart({commit}){
        axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
        return axios
        .get('http://app.abhiyantrik.com:6061/api/v1/wardvisualization',)
        .then(response => {
          if(response.status==200){
    ...
    listTreatmentTable({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://app.abhiyantrik.com:6061/api/v1/wardtreatmenttablevisualizaation',)
      .then(response => {
        if(response.status==200){
    ...
    listBasicTable({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://app.abhiyantrik.com:6061/api/v1/wardtablevisualization',)
      .then(response => {
        if(response.status==200){
    ...
    listWardSettingGraphs({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://app.abhiyantrik.com:6061/api/v1/wardsettingsgraph',)
      .then(response => {
        if(response.status==200){
    ...
    listWardTreatmentGraphs({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://app.abhiyantrik.com:6061/api/v1/wardtreatmentgraph',)
      .then(response => {
        if(response.status==200){
    ...
    listWardUserLineGraphs({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://app.abhiyantrik.com:6061/api/v1/waruserlinechart',)
      .then(response => {
        if(response.status==200){
    ...
    listWardStrategicData({commit}){
      axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
      return axios
      .get('http://app.abhiyantrik.com:6061/api/v1/wardstrategicdata',)
      .then(response => {
        if(response.status==200){
    ...
    //   axios.defaults.headers.common['authorization']  = 'JWT ' + this.state.token
    //   return axios
    //   .get('http://app.abhiyantrik.com:6061/api/v1/bargraphdata',)
    //   .then(response => {
    //     if(response.status==200){
